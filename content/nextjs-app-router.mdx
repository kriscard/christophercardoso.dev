---
title: An Overview of Next.js 13 with App Router
date: 2023-08-10
tag: Nextjs
summary: Next.js' App Router introduces a fresh approach to application development, utilizing React's latest features.
---
...
(add Vercel image + source link) 

React server components give us a tone of flexibility when building applications. Vercel has decided to make all components server components by default in App Router. Developers can switch to a client component by using the "use client" directive when they choose to. (link to [https://nextjs.org/docs/getting-started/react-essentials#the-use-client-directive](https://nextjs.org/docs/getting-started/react-essentials#the-use-client-directive))

// Add code examples of components with the “use client” directive. 

Now that we have a basic understanding of React server components let’s dive a bit more into the new routing concept. 
...
Here is a diagram that will explain how to create 3 different types of routing:

- `example.com/blog/123`
- `example.com/store/product/456`
- `example.com/about`

![app-router.png](Overview%20of%20Nextjs%2013%20with%20App%20Router%2028a55336098845babdb92c98ebe5d7a1/app-router.png)

![app-router_no_background.png](Overview%20of%20Nextjs%2013%20with%20App%20Router%2028a55336098845babdb92c98ebe5d7a1/app-router_no_background.png)
...
TODO: RECREATE THIS IMAGE [https://nextjs.org/docs/app/building-your-application/routing#component-hierarchy](https://nextjs.org/docs/app/building-your-application/routing#component-hierarchy) 

To get more details about these new file conventions, you can check the doc [here](https://nextjs.org/docs/app/building-your-application/routing#file-conventions).
...
**Note:** Every component that will use React hooks, such as useState, useEffect, and useRef must be client components, as server components will not be able to handle these states’ lifecycles. 
