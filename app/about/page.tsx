  ...
  return (
    <section>
      ...
      <p className="mb-8 text-xl lg:text-lg">
        ...
        <a className="font-semibold text-[#a171e1] hover:text-[#A5B4FB]" href="/blog">
          blog
        </a>
        &nbsp;and my&nbsp;
        <a className="font-semibold text-[#a171e1] hover:text-[#A5B4FB]" href="/#projects">
          projects
        </a>
        &nbsp;where I&apos;ll be sharing my insights, discoveries, and expertise.
        <br />
        <br />
        This site contains no ads, no sponsored posts, no affiliate links, and no paywalls. Just me
        sharing my knowledge and experience with you.
      </p>
    </section>
  )
}
